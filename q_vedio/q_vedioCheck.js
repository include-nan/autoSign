/*
cron "40 7 * * *" q_vedioCheck.js, tag=腾讯视频签到
*/
// V_COOKIE V_REF_URL SEND_KEY
...
function refCookie(url = ref_url) {
    return new Promise((resovle, reject) => {
        axios({url, headers}).then(e => {
            ...
            resovle({
                ...headers,
                Cookie: Object.keys(auth).map(i => i + '=' + auth[i]).join('; ').replace("video_platform=2", "video_platform=3"),
